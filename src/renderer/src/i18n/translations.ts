export const translations = {
  vi: {
    ...
    supportFormats: 'Hỗ trợ GLTF, GLB, STL, OBJ',
    ...
    scale: 'Tỉ lệ (Scale)',
    importFormatError: 'Chỉ hỗ trợ import file .gltf, .glb, .stl hoặc .obj!',
    importTypeTitle: 'Kiểu đối tượng Import',
    importTypeDesc: 'Vui lòng chọn kiểu đối tượng để hiển thị chính xác trong không gian 3D.',
    modelUnitTitle: 'Đơn vị của model',
    modelUnitDesc: 'Chọn đơn vị đã dùng khi model được xuất từ phần mềm thiết kế.',
    toolAxisTitle: 'Trục gá của đầu gắp',
    toolAxisDesc: 'Auto chọn trục dài nhất. Chọn dấu âm nếu mặt gá nằm ở đầu dương của trục.',
    normalObject: 'Vật thể phụ trợ (Environment)',
    normalObjectDesc: 'Đặt tự do trong không gian để mô phỏng tránh va chạm.',
    gripperTool: 'Đầu gắp (Gripper / Tool)',
    gripperToolDesc: 'Tự động gắn vào mặt bích cổ tay robot (TCP), xoay/di chuyển theo robot.',
    configToolTooltip: 'Cấu hình vị trí đầu gắp',
    ...
    blocklyBasicBlocks: 'Khối cơ bản',
    blocklyMoveAB: 'Di chuyển A → B',
    blocklyPointA: 'Điểm A',
    blocklyPointB: 'Điểm B',
    blocklyUnset: 'chưa set',
    blocklySpeed: 'tốc độ',
    blocklyAcc: 'gia tốc',
    blocklyDelaySeconds: 'giây',
    blocklySetPointA: 'Set A',
    blocklySetPointB: 'Set B',
    blocklySelectedMove: 'Block di chuyển đang chọn',
    blocklyNoMoveSelected: 'Chọn block Di chuyển A → B để ghi điểm A/B từ TCP hiện tại.',
    blocklySaveModule: 'Lưu Module',
    blocklySaveWorkflow: 'Lưu Workflow',
    blocklyProjectLibrary: 'Thư viện Project',
    blocklyAppLibrary: 'Thư viện App',
    blocklyBuiltinLibrary: 'Mẫu có sẵn',
    blocklyPickCup: 'Lấy cốc',
    blocklyPickCupDescription: 'Đi từ A đến B, đợi, rồi quay lại A.',
    blocklyWorkflowSample: 'Workflow mẫu',
    blocklyModuleNamePrompt: 'Tên module:',
    blocklyWorkflowNamePrompt: 'Tên workflow:',
    blocklySaveAppScopeConfirm: 'Lưu vào thư viện dùng chung của app? Bấm Cancel để chỉ lưu trong project.',
    blocklyLibrarySaveError: 'Lỗi lưu thư viện block:',
  ...
  en: {
    ...
    supportFormats: 'Supports GLTF, GLB, STL, OBJ',
    ...
    scale: 'Scale',
    importFormatError: 'Only .gltf, .glb, .stl or .obj file types are supported!',
    importTypeTitle: 'Import Object Type',
    importTypeDesc: 'Please select the object type for correct 3D spatial alignment.',
    modelUnitTitle: 'Model unit',
    modelUnitDesc: 'Select the unit used when the model was exported from the design software.',
    toolAxisTitle: 'Tool mounting axis',
    toolAxisDesc: 'Auto uses the longest axis. Choose a negative axis when the mount is on its positive end.',
    normalObject: 'Auxiliary Object (Environment)',
    normalObjectDesc: 'Placed freely in space for collision avoidance simulation.',
    gripperTool: 'Gripper / Tool',
    gripperToolDesc: 'Automatically attaches to the robot wrist flange (TCP), moves with robot.',
    configToolTooltip: 'Configure Tool Transform',
    ...
    blocklyBasicBlocks: 'Basic blocks',
    blocklyMoveAB: 'Move A → B',
    blocklyPointA: 'Point A',
    blocklyPointB: 'Point B',
    blocklyUnset: 'unset',
    blocklySpeed: 'speed',
    blocklyAcc: 'acc',
    blocklyDelaySeconds: 'seconds',
    blocklySetPointA: 'Set A',
    blocklySetPointB: 'Set B',
    blocklySelectedMove: 'Selected move block',
    blocklyNoMoveSelected: 'Select a Move A → B block to capture A/B from the current TCP.',
    blocklySaveModule: 'Save Module',
    blocklySaveWorkflow: 'Save Workflow',
    blocklyProjectLibrary: 'Project Library',
    blocklyAppLibrary: 'App Library',
    blocklyBuiltinLibrary: 'Built-in',
    blocklyPickCup: 'Pick cup',
    blocklyPickCupDescription: 'Move from A to B, wait, then return to A.',
    blocklyWorkflowSample: 'Workflow sample',
    blocklyModuleNamePrompt: 'Module name:',
    blocklyWorkflowNamePrompt: 'Workflow name:',
    blocklySaveAppScopeConfirm: 'Save to the shared app library? Press Cancel to save only in this project.',
    blocklyLibrarySaveError: 'Block library save error:',
